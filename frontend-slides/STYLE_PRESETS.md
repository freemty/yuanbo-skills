...
### 5. Steam and Steel (钢铁与蒸汽)

**Vibe:** Industrial revolution, historical, warm metallic, revolutionary

**Layout:** Left-aligned content on dark. Industrial grid background. Decorative gear elements.

**Typography:**
- Display: `Cormorant Garamond` (700) — historical elegance
...
**Signature Elements:**
- Industrial grid pattern (80px × 80px)
- Vertical accent bar on left edge with glow
- Bronze/gold metallic accents
- Decorative rotating gear elements
- Era labels with horizontal line prefix
- Left-aligned layout for editorial feel
- Radial gradient overlays for depth

**Animation Style:**
- Fade in from left (`translateX(-30px)`)
- Staggered delays for progressive reveal
- Slow gear rotation (20s linear infinite)
- Smooth easing (`cubic-bezier(0.16, 1, 0.3, 1)`)

**Use Cases:**
- Historical narratives
- Revolutionary/transformative topics
- Industrial or manufacturing content
- Presentations about technological evolution
- Content comparing past and future

**Design Philosophy:**
This style evokes the industrial revolution era while maintaining modern sophistication. The bronze/gold metallic tones reference the machinery and craftsmanship of the steam age, while the clean typography and layout keep it contemporary. Perfect for presentations that draw parallels between historical transformations and current innovations (e.g., "AI is the new steam engine").
